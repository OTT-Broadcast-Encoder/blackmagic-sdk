...
static const std::map<BMDDeckLinkStatusID, std::pair<GetStatusDataFunc, QString>> kStatusItems =
{
	...
	{ bmdDeckLinkStatusEthernetLink,						std::make_pair(std::bind(getStatusEthernetLinkState, _1, bmdDeckLinkStatusEthernetLink),					"Ethernet link state") },
	{ bmdDeckLinkStatusEthernetLinkMbps,					std::make_pair(std::bind(getStatusInt, _1, bmdDeckLinkStatusEthernetLinkMbps),								"Ethernet link speed (Mbps)") },
	{ bmdDeckLinkStatusEthernetLocalIPAddress,				std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetLocalIPAddress),						"Ethernet local IP address") },
	{ bmdDeckLinkStatusEthernetSubnetMask,					std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetSubnetMask),							"Ethernet subnet mask") },
	{ bmdDeckLinkStatusEthernetGatewayIPAddress,			std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetGatewayIPAddress),					"Ethernet gateway IP address") },
	{ bmdDeckLinkStatusEthernetPrimaryDNS,					std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetPrimaryDNS),							"Ethernet primary DNS IP address") },
	{ bmdDeckLinkStatusEthernetSecondaryDNS,				std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetSecondaryDNS),						"Ethernet secondary DNS IP address") },
	{ bmdDeckLinkStatusEthernetPTPGrandmasterIdentity,		std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetPTPGrandmasterIdentity),				"Ethernet PTP grandmaster identity") },
	{ bmdDeckLinkStatusEthernetVideoOutputAddress,			std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetVideoOutputAddress),					"Ethernet video output address") },
	{ bmdDeckLinkStatusEthernetAudioOutputAddress,			std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetAudioOutputAddress),					"Ethernet audio output address") },
	{ bmdDeckLinkStatusEthernetAncillaryOutputAddress,		std::make_pair(std::bind(getStatusString, _1, bmdDeckLinkStatusEthernetAncillaryOutputAddress),				"Ethernet ancillary output address") },
};
...
QString getStatusEthernetLinkState(com_ptr<IDeckLinkStatus>& deckLinkStatus, const BMDDeckLinkStatusID id)
{
	int64_t statusInt;
