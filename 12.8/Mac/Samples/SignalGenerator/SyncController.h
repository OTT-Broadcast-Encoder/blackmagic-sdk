...
using FillFrameFunction = std::function<void(com_ptr<IDeckLinkMutableVideoFrame>&, BOOL)>;
...
@interface SyncController : NSObject {
	...
	//
	com_ptr<SignalGenerator3DVideoFrame>	videoFrameBlack;
	com_ptr<SignalGenerator3DVideoFrame>	videoFrameBars;
	//
	...
	BMDAudioSampleType			audioSampleDepth;
